...
#####################################################################
#####################################################################
##Author -Vishwaprabhakar singh
##url: fiverr.com/vtechcoder
##
##
#####################################################################
#####################################################################
...
#####################################################################
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    System Status Check  [CPU,Process,Disk Usage, Memory]
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
#####################################################################
...
file_name="health-`hostname`-`date +%y%m%d`-`date +%H%M`.txt"
sysstat > $file_name
echo -e "Reported file $file_name generated in current directory." $RESULT
if [ "$EMAIL" != '' ] 
then
	STATUS=`which mail`
	if [ "$?" != 0 ] 
	then
		...
		cat $file_name | mail -s "$file_name" $EMAIL
	fi
fi
cat $file_name
